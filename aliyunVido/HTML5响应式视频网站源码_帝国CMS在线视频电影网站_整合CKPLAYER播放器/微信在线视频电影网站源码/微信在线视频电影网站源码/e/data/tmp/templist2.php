...
<div class="focusbanner">
  <div class="container"> <script src="[!--news.url--]e/member/login/loginjs2.php"></script>
  </div>
</div>
<section class="container">
  <div class="content-wrap">
    <div class="content">
      <div class="title">
        <h3> 最新发布 </h3>
        <div class="more"><a href="[!--news.url--]hot/">热门浏览</a><a href="[!--news.url--]zan/">最多赞</a>&nbsp;&nbsp;&nbsp;&nbsp;</div>
      </div>
...
<div class="yqlj">
  <div class="yqljbt">
    ...
    <div class="yqljbt_r"><a href="[!--news.url--]e/extend/doaddlink/" target="_blank">申请</a></div>
  </div>
  <div class="yqljlb">
    <ul>
      <?php
