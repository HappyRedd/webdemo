...
{
?>
document.write("Hi, <?=$myusername?>				&nbsp; &nbsp; <a href=\"/e/member/cp/\">进入会员中心</a>");
<?
}
else
{
?>
document.write("<a href=\"/e/member/login/\" class=\"signin-loader\">Hi, 请登录</a> &nbsp; &nbsp; <a href=\"/e/member/register/index.php?tobind=0&groupid=1\" class=\"signup-loader\">我要注册</a> &nbsp; &nbsp; <a href=\"/e/DoInfo/ChangeClass.php?mid=1\">发布投稿</a>");
<?
}
?>