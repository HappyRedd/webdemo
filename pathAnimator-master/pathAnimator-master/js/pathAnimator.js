...
PathAnimator.prototype = {
	start : function( duration, step, reverse, startPercent, endPercent,callback, easing ){
		this.stop();
		...
		(function calc(){
			...
			if( percent > 100 || percent < 0 || (percent >= endPercent && !reverse) || (percent <= endPercent && reverse)){
				that.stop();
